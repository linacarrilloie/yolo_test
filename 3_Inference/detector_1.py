...
if __name__ == "__main__":
    ...
    if input_image_paths:
        ...
        while True:
            ...
            # save the image
            cv2.imwrite('../Data/Source_Images/Test_Images/frame.jpg', frame)
            img_path='../Data/Source_Images/Test_Images/frame.jpg'
            # detect object on our frame
            # prediction is saved as frame_catface.jpg in Results folder
            ...
            # now just read the predicted image and do a cv2.imshow()
            image2 = cv2.imread('../Data/Source_Images/Test_Image_Detection_Results/frame_catface.jpg')
            cv2.imshow("Web cam input", image2)
